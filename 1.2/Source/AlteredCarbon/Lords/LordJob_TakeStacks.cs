...
namespace AlteredCarbon
{
	...
	{
		protected DutyDef DutyDef => AlteredCarbonDefOf.AC_TakeStacks;
		...
		protected bool TryFindGoodOpportunisticTaskTarget(Pawn pawn, out Thing target, List<Thing> alreadyTakenTargets)
		{
			...
			var corticalStacks = pawn.Map.listerThings.ThingsOfDef(AlteredCarbonDefOf.AC_FilledCorticalStack).Cast<CorticalStack>().Where(x => x.faction == pawn.Faction);
